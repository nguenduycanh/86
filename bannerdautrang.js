...
$(window).load(function() {
		if(document.cookie.indexOf("adf") == -1)
		{
			...
			$("#myModal").html("<a href='http://nguyenduycanh.com/' target='_blank'><img src='http://nguyenduycanh.com/wp-content/uploads/2017/10/pc.jpg' width='500px'/><br/>Căn hộ Xanh </a> tiêu chuẩn Mỹ đầu tiên tại Việt Nam. Hotline: 0919 8888 26. <h2><a class='close-linhnguyen-modal'>X</a></h2>");
			$('#myModal').nguyenduycanh($('#myModal').data());
		}
});
